...
import com.gdgkoreaandroid.holotomaterial.R;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private int mSelectedTapStripIndex = 0;
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        int[] colors = new int[] {
                Color.WHITE,
                getResources().getColor(R.color.white_alpha_54),
        };
    ...
    private synchronized void setSelectedTab(int tabIndex) {
        View oldSelectedChild = mTabStrip.getChildAt(mSelectedTapStripIndex);
        ...
        mSelectedTapStripIndex = tabIndex;
    }
